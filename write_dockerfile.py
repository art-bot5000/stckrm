...
"
    ...
    handle @landingHost {
        ...
        header {
            ...
            Content-Security-Policy-Report-Only "default-src 'self'; script-src 'self' 'unsafe-inline'; style-src 'self' 'unsafe-inline' https://fonts.googleapis.com; img-src 'self' data: https:; font-src 'self' data: https://fonts.gstatic.com; connect-src 'self'; frame-ancestors 'none'; base-uri 'self'; form-action 'self'; object-src 'none'"
    ...
    handle {
        ...
        header {
            ...
            X-Frame-Options "DENY"
            Cross-Origin-Opener-Policy "same-origin"
            Content-Security-Policy-Report-Only "default-src 'self'; script-src 'self' 'unsafe-inline' https://cdnjs.cloudflare.com; style-src 'self' 'unsafe-inline' https://fonts.googleapis.com; img-src 'self' data: https:; font-src 'self' data: https://fonts.gstatic.com; connect-src 'self' https://world.openfoodfacts.org https://world.openbeautyfacts.org https://api.allorigins.win; frame-ancestors 'none'; base-uri 'self'; form-action 'self'; object-src 'none'"
            Referrer-Policy "strict-origin-when-cross-origin"
            Permissions-Policy "camera=*, microphone=()"
            -Server
        }
...
COPY package.json ./
RUN npm install
COPY app.js budget.js budget-ui.js notes.js notes-ui.js demo.js scanner.js ./

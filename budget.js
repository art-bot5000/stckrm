// ═══════════════════════════════════════════════════════════════════════════
//  BUDGET MODULE (extracted from app.js)
//
//  This file contains the entire Budget feature, factored out of app.js
//  to keep the main bundle smaller and make Budget changes easier to
//  reason about. It is a plain script (NOT an ES module) — every
//  top-level function and `let`/`const` declaration here remains in the
//  global scope, exactly as it was when it lived in app.js. The omnibox
//  (in app.js) calls back into Budget by name (bills, openQuickAddSpend,
//  renderBudget, etc.) and inline onclick attributes in index.html call
//  Budget functions by name; both rely on global scope and continue to
//  work without changes.
//
//  Load order in index.html MUST be: app.js FIRST, then budget.js.
//  Budget depends on app.js for: dbGet, dbPut, _syncQueue, _kvEmailHash,
//  _shareState, toast, openModal, closeModal, scheduleRender, canWrite,
//  showLockBanner, applyTabPermissions, registerBulkSelectSection,
//  registerSharingSection, uid, saveData, _nowIso, esc, ic, etc.
//  app.js depends on budget.js for: bills, transactions, budgetCategories,
//  billInstances, budgetAccounts, incomeTemplates, incomeEntries,
//  budgetSettings, and the tombstone arrays (all referenced via _searchBudget,
//  share filtering, sync merge functions, omnibox, etc.).
//
//  Both files must land in GitHub together for this to work.
// ═══════════════════════════════════════════════════════════════════════════
